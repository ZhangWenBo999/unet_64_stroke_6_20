...
from module_test.previous.a6_CRA import *
...
class CCSABlock(nn.Module):
    def __init__(self, 
        ...
        if self.channel_att:
            ...
            self.c_attention = nn.ModuleList([CRA(in_channels=feature, reduction_ratio=4) for feature, head in zip(features, channel_head)])
