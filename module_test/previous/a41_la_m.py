...
'''
论文题目：揭开视觉中曼巴的神秘面纱：线性注意力视角   arxiv 2024

Mamba 模型在高分辨率视觉任务中表现出色，研究揭示其与线性注意力转换器相似但表现更优。
Mamba 的成功主要归因于遗忘门和改进块设计。这些因素显著提升了模型性能。
提出了类似曼巴的线性注意力（MLLA）模型，在图像分类和高分辨率密集预测任务中表现优异。
...
class MKLAttention(nn.Module):
    r"""  KAN Linear Attention with LePE and RoPE.
    Args:
