...
# from module_test.CBAM import *
from module_test.previous.msff_cbam import *
...
class CCSABlock(nn.Module):
    def __init__(self, 
        ...
        if self.channel_att:
            ...
            self.c_attention = nn.ModuleList([msff_cbam(dim=feature) for feature, head in zip(features, channel_head)])
