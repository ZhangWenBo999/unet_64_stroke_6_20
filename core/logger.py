...
class VisualWriter():
    ...
    def save_images_valid_test(self, results):
    ...
    #     result_path = os.path.join(self.result_dir, "test")
    #     os.makedirs(result_path, exist_ok=True)
    #     result_path = os.path.join(result_path, str(self.epoch))
    #     os.makedirs(result_path, exist_ok=True)
    #     GT_path = os.path.join(result_path, 'GT')
    ...
    def save_images_best(self, results):
        result_path = os.path.join(self.result_dir, "best")
        os.makedirs(result_path, exist_ok=True)
        result_path = os.path.join(result_path, str(self.epoch))
        os.makedirs(result_path, exist_ok=True)
        GT_path = os.path.join(result_path, 'GT')
