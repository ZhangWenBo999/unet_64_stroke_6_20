...
from module_test.previous.GAM import *
...
class CCSABlock(nn.Module):
    def __init__(self, 
        ...
        if self.channel_att:
            ...
            self.c_attention = nn.ModuleList([GAM_Attention(in_channels=feature, out_channels=feature) for feature, head in zip(features, channel_head)])
