...
from lama_pl.ade20k.base import ModelBuilder
from lama_pl.utils import check_and_warn_input_range
...
class PerceptualLoss(nn.Module):
    ...
    def partial_losses(self, input, target, mask=None):
        ...
        for layer in self.vgg[:30]:
            ...
            # features_input = layer(features_input.cpu())
            # features_target = layer(features_target.cpu())
