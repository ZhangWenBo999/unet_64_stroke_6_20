...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        ## modify_ffc
        # self.input_blocks2 = EmbedSequential(FFC_BN_ACT(in_channels=ch, out_channels=ch, kernel_size=3, padding=1, ratio_gin=0.5,
        #             ratio_gout=0.5))
        # self.input_blocks = nn.ModuleList([])
        ...
        self.middle_block = EmbedSequential(
            ...
            # FFC_BN_ACT(in_channels=ch, out_channels=ch, kernel_size=3, padding=1, ratio_gin=0.5,
            #            ratio_gout=0.5),
